 ...
 */
@Entity
@Table(name = "tran_bill_detail")
public class TranBillDetail implements Serializable
{
	...
	@EmbeddedId
	public
	TranBillDetailKey TranBillDetailKey;

	String product_name;
	String alt_product_code;
	BigDecimal order_qty;
	BigDecimal bill_qty;
	BigDecimal returned_qty;
	...
	@Transient
	BigDecimal item_total;

	
	
	
	public TranBillDetail()
	{
		TranBillDetailKey = new TranBillDetailKey();
		setTranBillDetailKey(TranBillDetailKey);
	}
	...
	public TranBillDetailKey getTranBillDetailKey() {
		return TranBillDetailKey;
	}


	public void setTranBillDetailKey(TranBillDetailKey tranBillDetailKey) {
		TranBillDetailKey = tranBillDetailKey;
	}
	...
	public BigDecimal getBill_qty() {
		if(bill_qty == null)
			bill_qty = BigDecimal.ZERO;
		return bill_qty;
	}


	public void setBill_qty(BigDecimal bill_qty) {
		this.bill_qty = bill_qty;
	}


	public BigDecimal getReturned_qty() {
		if(returned_qty == null)
			returned_qty = BigDecimal.ZERO;
		return returned_qty;
	}
	...
	public BigDecimal getItem_total() {
		if(item_total == null)
			item_total = BigDecimal.ZERO;
		return item_total.setScale(2);
	}
